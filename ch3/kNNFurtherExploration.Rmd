...
#Since we are using many more predictors, lets try to train our model using the first 100 records, and test the last 38 
injury_train <- injury_predictors[1:100,]
injury_test <- injury_predictors[101:138,]
injury_train_labels <- injury_subset[1:100, 10] #surgery is column 9
injury_test_labels <- injury_subset[101:138, 10]
```
```{r}
